            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="inbox.html">
                                <i class="fas fa-trophy"></i>Features</a>
                            
                        </li>
                        <li>
                            <a href="inbox.html">
                                <i class="fas fa-unlock-alt"></i>Credentials</a>
                            
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-th-list"></i>Validators
                                <span class="arrow">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="form.html">
                                        <i class="fa fa-globe"></i>Public Validators</a>
                                </li>
                                <li>
                                    <a href="table.html">
                                        <i class="fa fa-pencil-square-o"></i>Custom Validators</a>
                                </li>
                        ...
                        <li>
                            <a href="inbox.html">
                                <i class="fas fa-puzzle-piece"></i>Integration</a>
                            
                        </li>
                        
                        <li>
                            <a href="inbox.html">
                                <i class="fa fa-credit-card"></i>Pricing</a>
                        </li>
